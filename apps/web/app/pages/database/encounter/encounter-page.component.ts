...
import { EncounterTableAdapter } from '../../../widgets/data/encounter-table'
import { SplitGutterComponent, SplitPaneDirective } from '../../../ui/split-container'

@Component({
  selector: 'nwb-encounter-page',
...
export class EncounterPageComponent {
  protected title = 'Encounter'
  protected filterParam = 'filter'
  protected selectionParam = 'id'
  protected persistKey = 'encounter-table'
